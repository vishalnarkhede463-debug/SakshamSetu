...
const DEFAULT_STORE = {
  ...
  applications: [
    { id: 1, opportunityId: 1, studentId: 1, status: "SHORTLISTED", coverNote: "COEP CSE graduate, Oracle Certified Java developer.", appliedAt: "2026-08-10", interview: { type: "ONLINE", date: "2026-09-25", time: "10:30 AM", link: "https://meet.google.com/saksham-isro-2026", venue: "Google Meet Virtual Panel", notes: "Technical assessment round on Data Structures, Java Enterprise & Satellite Telemetry.", status: "INVITED", invitedAt: "2026-09-15" } },
    ...
    { id: 8, opportunityId: 2, studentId: 3, status: "SHORTLISTED", coverNote: "B.Tech Mechanical from VNIT Nagpur.", appliedAt: "2026-08-05", interview: { type: "OFFLINE", date: "2026-09-28", time: "09:30 AM", link: "", venue: "Administrative Complex, BHEL Plant, Wardha Road, Nagpur, Maharashtra", notes: "Report at Gate 2 Reception with 2 sets of attested academic certificates & Aadhaar card.", status: "ACCEPTED", invitedAt: "2026-09-15" } },
  ...
  notifications: [
    { id: 1, userId: 7, title: "Interview Invitation: ISRO Engineer", message: "You are invited for an Online Technical Interview for Junior Scientist / Engineer at ISRO. Scheduled for 25th September at 10:30 AM via Google Meet.", category: "INTERVIEW", priority: "URGENT", actionUrl: "applications.html", read: false, createdAt: "2026-09-15 10:30" },
    { id: 2, userId: 7, title: "Application Shortlisted", message: "Congratulations! Your application for Systems Engineer Trainee at Tata Consultancy Services has been shortlisted for HR Round.", category: "APPLICATION", priority: "HIGH", actionUrl: "applications.html", read: false, createdAt: "2026-09-14 14:15" },
    { id: 3, userId: 7, title: "Scheme Deadline Alert", message: "Reminder: Last 7 days remaining to apply for PM Internship Scheme 2026 monthly stipend grant.", category: "DEADLINE", priority: "HIGH", actionUrl: "opportunity-details.html?id=4", read: false, createdAt: "2026-09-12 09:00" },
    { id: 4, userId: 7, title: "Skill Verification Certificate Ready", message: "Your Oracle Certified Java Developer credentials have been cryptographically verified and anchored in TEE.", category: "SYSTEM", priority: "MEDIUM", actionUrl: "student-profile.html", read: true, createdAt: "2026-09-10 11:20" },
    { id: 5, userId: 7, title: "New Government Scheme Matched", message: "MahaDBT Post-Matric Scholarship Scheme matches your state domicile and education profile.", category: "SCHEME", priority: "MEDIUM", actionUrl: "government-schemes.html", read: true, createdAt: "2026-09-08 16:45" },
    { id: 6, userId: 8, title: "Interview Call: PMIS Fellowship", message: "Panel interview scheduled for Prime Minister Internship Scheme at Mantralaya Mumbai.", category: "INTERVIEW", priority: "URGENT", actionUrl: "applications.html", read: false, createdAt: "2026-09-14 16:45" },
    { id: 7, userId: 8, title: "Skill Verified: JavaScript", message: "Your skill \"JavaScript\" has been verified following document review.", category: "SYSTEM", priority: "LOW", actionUrl: "student-profile.html", read: true, createdAt: "2026-09-03 12:00" },
    { id: 8, userId: 9, title: "Interview Call: BHEL Apprenticeship", message: "Offline trade test and physical interview at BHEL Electrical Plant Nagpur.", category: "INTERVIEW", priority: "URGENT", actionUrl: "applications.html", read: false, createdAt: "2026-09-15 15:30" },
    { id: 9, userId: 11, title: "Offer Letter Released: MSInS", message: "You have been selected for the AI & Machine Learning Research Fellowship at MSInS.", category: "APPLICATION", priority: "HIGH", actionUrl: "applications.html", read: false, createdAt: "2026-09-04 11:10" }
  ],
  governmentPrograms: [
  ...
  skillResources: [
    {
      ...
      title: "Mastering Java Enterprise & Cloud Architecture",
      source: "NPTEL / IIT Kharagpur (Govt Accredited)",
      duration: "36 Hours",
      difficulty: "INTERMEDIATE",
      nsqfLevel: "Level 6",
      description: "Complete foundational and enterprise Java curriculum covering OOP, Collections Framework, Multithreading, JDBC, Spring Boot microservices, and Docker deployment.",
      videoEmbedUrl: "https://www.youtube-nocookie.com/embed/grEKMHGYyns",
      modules: [
        { title: "Module 1: Java Basics & Memory Model", duration: "6 hrs", notes: "JVM, JRE, Bytecode, Garbage Collection algorithms, stack vs heap allocation." },
        { title: "Module 2: Object Oriented Design & SOLID Principles", duration: "8 hrs", notes: "Polymorphism, abstraction, encapsulation, design patterns (Singleton, Factory, Observer)." },
        { title: "Module 3: Collections & Concurrency Architecture", duration: "10 hrs", notes: "ArrayList, HashMap internal working, synchronized blocks, ExecutorService, CompletableFuture." },
        { title: "Module 4: Spring Boot REST APIs & JPA Hibernate", duration: "12 hrs", notes: "Dependency injection, JPA repository queries, transaction management, JWT authentication." }
      ],
      practiceQuestions: [
        { q: "What is the time complexity of HashMap.get() in average case?", a: "O(1) through bucket hashing." },
        { q: "Explain the difference between fail-fast and fail-safe iterators in Java Collections.", a: "Fail-fast throws ConcurrentModificationException; fail-safe operates on a cloned copy." }
      ]
    },
    {
      id: 2,
      ...
      source: "IIT Madras / Digital India",
      duration: "40 Hours",
      difficulty: "INTERMEDIATE",
      nsqfLevel: "Level 6",
      description: "End-to-end Python pipeline from scientific computing with NumPy and Pandas to predictive modeling with Scikit-learn and Deep Learning basics.",
      videoEmbedUrl: "https://www.youtube-nocookie.com/embed/_uQrJ0TkZlc",
      modules: [
        { title: "Module 1: Python Advanced Idioms & Generators", duration: "8 hrs", notes: "List comprehensions, decorators, context managers, lambda functions, and typing." },
        { title: "Module 2: Data Wrangling with NumPy & Pandas", duration: "10 hrs", notes: "Vectorized operations, handling missing values, groupby transformations, merging datasets." },
        { title: "Module 3: Statistical Modeling & Scikit-Learn", duration: "12 hrs", notes: "Linear/Logistic regression, Decision Trees, Random Forests, cross-validation and hyperparameter tuning." },
        { title: "Module 4: Neural Networks & Model Deployment", duration: "10 hrs", notes: "Perceptrons, backpropagation, PyTorch basics, and exporting models via FastAPI." }
      ],
      practiceQuestions: [
        { q: "What is broadcasting in NumPy?", a: "The mechanism allowing arithmetic operations on arrays of different shapes." },
        { q: "How does L1 regularization differ from L2 in regression?", a: "L1 (Lasso) drives coefficients to zero performing feature selection; L2 (Ridge) shrinks coefficients smoothly." }
      ]
    },
    {
      id: 3,
      ...
      title: "National Cyber Defense & SOC Threat Analyst",
      source: "CDAC Pune / Ministry of Electronics & IT",
      duration: "45 Hours",
      difficulty: "ADVANCED",
      nsqfLevel: "Level 7",
      description: "Defensive and offensive security methodologies, network packet dissection, intrusion detection, cryptography, and Indian Cyber Laws (IT Act 2000).",
      videoEmbedUrl: "https://www.youtube-nocookie.com/embed/inWWhr5tnEA",
      modules: [
        { title: "Module 1: Network Protocols & Wireshark Analysis", duration: "10 hrs", notes: "TCP/IP handshake, ARP poisoning, DNS spoofing, packet inspection, firewall configuration." },
        { title: "Module 2: Vulnerability Assessment & Pen-Testing", duration: "12 hrs", notes: "OWASP Top 10, SQL Injection, XSS, CSRF, Metasploit fundamentals, Nmap reconnaissance." },
        { title: "Module 3: Security Information & Event Management (SIEM)", duration: "12 hrs", notes: "Log aggregation, SOC workflow, threat hunting, incident response playbooks." },
        { title: "Module 4: Cryptography & Public Key Infrastructure", duration: "11 hrs", notes: "Symmetric vs asymmetric encryption, RSA, AES-256, digital signatures, SSL/TLS handshakes." }
      ],
      practiceQuestions: [
        { q: "What is the purpose of a Salt in password hashing?", a: "Prevents rainbow table lookups and ensures identical passwords yield different hashes." },
        { q: "How does a SYN Flood attack overwhelm a server?", a: "By filling the TCP half-open connection queue without sending final ACK packets." }
      ]
    },
    {
      id: 4,
      ...
      category: "Software Engineering",
      title: "Accessible & Modern Full-Stack Web Development",
      source: "Skill India Digital / National Skill Development Corp",
      duration: "38 Hours",
      difficulty: "BEGINNER",
      nsqfLevel: "Level 5",
      description: "Building responsive, W3C/GIGW-compliant web applications using HTML5 semantic layout, modern CSS Grid/Flexbox, JavaScript ES6+, and REST APIs.",
      videoEmbedUrl: "https://www.youtube-nocookie.com/embed/mU6anWqZJcc",
      modules: [
        { title: "Module 1: Semantic HTML5 & Web Accessibility (WCAG 2.1)", duration: "8 hrs", notes: "ARIA landmarks, screen-reader optimization, keyboard navigation, color contrast ratios." },
        { title: "Module 2: Modern CSS Architecture & Grid Systems", duration: "10 hrs", notes: "CSS custom properties, media queries, mobile-first design, animations, micro-interactions." },
        { title: "Module 3: JavaScript Asynchronous Programming & DOM", duration: "12 hrs", notes: "Promises, async/await, Fetch API, event delegation, LocalStorage management." },
        { title: "Module 4: API Integration & Security Best Practices", duration: "8 hrs", notes: "CORS, Content Security Policy, sanitizing user inputs against XSS, token storage." }
      ],
      practiceQuestions: [
        { q: "What is the primary difference between localStorage and sessionStorage?", a: "localStorage persists across browser sessions; sessionStorage clears on tab close." },
        { q: "Why is semantic HTML critical for web accessibility?", a: "Screen readers rely on tags like <main>, <nav>, <header> to convey hierarchy to visually impaired users." }
      ]
    }
  ],
  assessments: [
    {
      id: 1,
      skillName: "Java",
      title: "National Certification Assessment in Core & Enterprise Java",
      durationMinutes: 15,
      ...
      questions: [
        {
          id: 1,
          question: "Which of the following interfaces does NOT allow duplicate elements?",
          options: ["List", "Set", "Queue", "Collection"],
          correct: 1,
          explanation: "The Set interface models the mathematical set abstraction and does not allow duplicate entries."
        },
        {
          id: 2,
          question: "What happens when an unhandled exception occurs in a Java thread?",
          options: [
            "The JVM terminates immediately",
            "The thread terminates, but other threads continue running",
            "The exception is automatically converted to a RuntimeException",
            "The thread retries the failed operation"
          ],
          correct: 1,
          explanation: "Java isolates threads; an unhandled exception terminates that specific thread while other user threads continue."
        },
        {
          id: 3,
          ...
          correct: 2,
          explanation: "A method declared with 'final' cannot be overridden by subclasses."
        },
        {
          id: 4,
          ...
          options: ["0", "10", "16", "32"],
          correct: 1,
          explanation: "Default capacity is 10 once the first element is added."
        },
        {
          id: 5,
          question: "Which garbage collector in Java is optimized for low latency and large heap sizes?",
          options: ["Serial GC", "Parallel GC", "ZGC / G1 GC", "CMS Only"],
          correct: 2,
          explanation: "ZGC (Z Garbage Collector) and G1 GC are concurrent collectors targeting sub-millisecond pause times."
        }
      ]
    },
    {
      id: 2,
      skillName: "Python",
      title: "National Certification Assessment in Python & Data Analytics",
      durationMinutes: 15,
      passingPercentage: 60,
      totalQuestions: 5,
      nsqfLevel: "Level 6",
      questions: [
        {
          ...
          options: ["<class 'function'>", "<class 'lambda'>", "<class 'object'>", "<class 'generator'>"],
          correct: 0,
          explanation: "In Python, anonymous functions created via lambda are instances of the standard function type."
        },
        {
          id: 2,
          question: "Which Pandas method is used to remove missing/NaN values from a DataFrame?",
          options: ["df.fillna()", "df.dropna()", "df.isna()", "df.pop()"],
          correct: 1,
          explanation: "dropna() removes rows or columns containing missing values."
        },
        {
          id: 3,
          question: "In Python, which data structure maintains key insertion order by default (Python 3.7+)?",
          options: ["dict", "set", "frozenset", "tuple"],
          correct: 0,
          explanation: "Standard Python dict guarantees insertion order from version 3.7 onwards."
        },
        {
          id: 4,
          question: "What does the GIL (Global Interpreter Lock) in CPython prevent?",
          options: [
            "Multiple CPU cores from executing Python bytecode simultaneously in a single process",
            "Garbage collection from reclaiming cyclic references",
            "File I/O operations from blocking the main thread",
            "Importing C extensions concurrently"
          ],
          correct: 0,
          explanation: "CPython's GIL restricts execution of Python bytecode to one native thread at a time per process."
        },
        {
          id: 5,
          question: "What is the primary evaluation metric used for an imbalanced classification problem?",
          options: ["Accuracy", "ROC-AUC / F1-Score", "Mean Squared Error", "R-squared"],
          correct: 1,
          explanation: "Accuracy is misleading under class imbalance; F1-score and ROC-AUC measure precision and recall balance."
        }
      ]
    },
    {
      id: 3,
      skillName: "Cyber Security",
      title: "Government Certification in Cyber Defense & Network Security",
      durationMinutes: 15,
      passingPercentage: 60,
      totalQuestions: 5,
      nsqfLevel: "Level 7",
      questions: [
        {
          id: 1,
          question: "Which port is used by default for secure HTTPS communication?",
          options: ["80", "443", "8080", "22"],
          correct: 1,
          explanation: "HTTPS defaults to TCP port 443 with TLS/SSL encryption."
        },
        {
          id: 2,
          question: "What type of attack involves injecting malicious SQL commands into input fields?",
          options: ["Cross-Site Scripting (XSS)", "SQL Injection (SQLi)", "Man-in-the-Middle (MitM)", "Buffer Overflow"],
          correct: 1,
          explanation: "SQLi exploits unescaped database queries to execute arbitrary SQL commands."
        },
        {
          id: 3,
          question: "In Public Key Cryptography (Asymmetric), which key is used to decrypt a message encrypted with the recipient's public key?",
          options: ["Sender's Private Key", "Recipient's Private Key", "Shared Symmetric Key", "Sender's Public Key"],
          correct: 1,
          explanation: "Data encrypted with the recipient's public key can only be decrypted by the recipient's corresponding private key."
        },
        {
          id: 4,
          question: "What does CIA stand for in Information Security architecture?",
          options: [
          ...
          correct: 1,
          explanation: "The CIA Triad forms the foundational pillars of information security."
        },
        {
          id: 5,
          question: "Which section of the Indian Information Technology Act (IT Act 2000) addresses hacking and unauthorized computer access?",
          options: ["Section 43 & Section 66", "Section 124A", "Section 302", "Section 377"],
          correct: 0,
          explanation: "Section 43 covers penalty for damage to computer systems and Section 66 prescribes imprisonment for computer-related offenses."
        }
      ]
    }
  ]
...
// ----------------------------------------------------------------------------
function calculateSkillGap(student, opp) {
  if (!opp) return { matchedSkills: [], missingSkills: [], matchPercentage: 0 };
  const rawSkills = (opp.skills || '').split(/[,;]/).map(s => s.trim()).filter(Boolean);
  const studentSkills = (student && student.skillsList ? student.skillsList : []).map(s => (s.name || '').toLowerCase().trim());

  const matched = [];
  const missing = [];

  rawSkills.forEach(req => {
    const low = req.toLowerCase();
    const isMatched = studentSkills.some(stu => stu === low || stu.includes(low) || low.includes(stu));
    if (isMatched) {
      matched.push(req);
    } else {
      missing.push(req);
  ...
  const pct = rawSkills.length > 0 ? Math.round((matched.length / rawSkills.length) * 100) : 100;
  return { matchedSkills: matched, missingSkills: missing, matchPercentage: pct };
}
...
const API = {
  ...
  async route(method, endpoint, body = {}, params = {}) {
      ...
      if (method === 'GET') {
        ...
        if (user && user.role === 'STUDENT') {
          ...
          if (student) {
            ...
            const gap = calculateSkillGap(student, opp);
            matchedSkills = gap.matchedSkills;
            missingSkills = gap.missingSkills;
          }
        }

        return { opportunity: opp, matchScore, isSaved, hasApplied, matchedSkills, missingSkills, skillGap: missingSkills };
      }
    ...
    if (clean.startsWith('/applications/')) {
      ...
      if (app && method === 'PUT') {
        ...
        if (stu) {
          ...
          if (stu.email) {
            const subject = `Application Update: ${opp ? opp.title : 'Opportunity'} [${app.status.replace('_', ' ')}]`;
            const body = `Dear ${stu.name},\n\nYour application status for "${opp ? opp.title : 'Opportunity'}" has been updated to: ${app.status.replace('_', ' ')}.\n\nLog in to your Saksham Setu candidate portal to view complete details.\n\nBest regards,\nRecruitment & Selection Directorate`;
            this.sendEmailNotification(stu.email, subject, body);
          }
        }
      ...
      // Schedule Interview
      if (app && clean.endsWith('/interview') && method === 'POST') {
        const interviewData = {
          type: body.type || 'ONLINE',
          date: body.date || '2026-09-30',
          time: body.time || '11:00 AM',
          link: body.link || (body.type === 'ONLINE' ? 'https://meet.google.com/saksham-setu-interview' : ''),
          venue: body.venue || (body.type === 'OFFLINE' ? 'Office Headquarters Reception Desk' : 'Online Video Conference'),
          notes: body.notes || 'Please be available 10 minutes prior with original documents.',
          status: 'INVITED',
        ...
        // Send urgent notification to candidate
        const stu = LocalStore.get('studentProfiles').find(s => s.id === app.studentId);
        const opp = LocalStore.get('opportunities').find(o => o.id === app.opportunityId);
        if (stu) {
          const notifs = LocalStore.get('notifications');
          notifs.unshift({
            id: notifs.length + 10,
            userId: stu.userId,
            title: `Interview Invitation: ${opp ? opp.title : 'Position'}`,
            message: `You have been officially invited for an ${interviewData.type} interview on ${interviewData.date} at ${interviewData.time}. Location/Link: ${interviewData.type === 'ONLINE' ? 'Virtual Meeting Link' : interviewData.venue}.`,
            category: "INTERVIEW",
            priority: "URGENT",
          ...
          // Dispatch Email to candidate with meeting link
          if (stu.email) {
            const subject = `Official Interview Call: ${opp ? opp.title : 'Position'} - GovSkill Connect`;
            const body = `Dear ${stu.name},\n\nYou have been invited to an ${interviewData.type} interview on ${interviewData.date} at ${interviewData.time}.\n\nFormat: ${interviewData.type}\n${interviewData.type === 'ONLINE' ? 'Video Meeting Link: ' + interviewData.link : 'Reporting Venue: ' + interviewData.venue}\n\nInstructions: ${interviewData.notes}\n\nPlease log in to your dashboard to confirm your attendance.\n\nBest regards,\nMinistry of Skill Development & Entrepreneurship`;
            this.sendEmailNotification(stu.email, subject, body, interviewData.type === 'ONLINE' ? interviewData.link : '');
          }
        }

        return { success: true, message: 'Interview scheduled and invitation dispatched.', application: app };
      }

      // Candidate Interview Response (Accept/Decline)
      if (app && clean.endsWith('/interview-response') && method === 'POST') {
        if (!app.interview) app.interview = {};
        app.interview.status = body.response || 'ACCEPTED';
        LocalStore.set('applications', allApps);

        return { success: true, message: `Interview invitation marked as ${app.interview.status}.`, application: app };
      }
    }
    ...
    if (clean === '/employer/interviews') {
      ...
      const myOppIds = allOpps.filter(o => employer ? o.employerId === employer.id : true).map(o => o.id);
      const interviewApps = allApps.filter(a => myOppIds.includes(a.opportunityId) && a.interview).map(a => {
        const opp = allOpps.find(o => o.id === a.opportunityId) || {};
        const stu = allStudents.find(s => s.id === a.studentId) || {};
        return {
          applicationId: a.id,
          ...
          studentCollege: stu.college,
          status: a.status,
          interview: a.interview
        };
      });

      return { interviews: interviewApps, count: interviewApps.length };
    }
    ...
    if (clean === '/notifications') {
      const user = this.getUser();
      let notifs = LocalStore.get('notifications').filter(n => n.userId === (user ? user.id : 7));
      const totalUnread = notifs.filter(n => !n.read).length;
      
      const categoryCounts = {
        ALL: notifs.length,
        INTERVIEW: notifs.filter(n => n.category === 'INTERVIEW').length,
        APPLICATION: notifs.filter(n => n.category === 'APPLICATION').length,
        SCHEME: notifs.filter(n => n.category === 'SCHEME').length,
        DEADLINE: notifs.filter(n => n.category === 'DEADLINE').length,
        SYSTEM: notifs.filter(n => n.category === 'SYSTEM').length
      };

      if (params.category && params.category !== 'ALL') {
        notifs = notifs.filter(n => (n.category || 'SYSTEM') === params.category);
      }

      return { notifications: notifs, unreadCount: totalUnread, categoryCounts };
    }
    ...
    // 11. SKILL DEVELOPMENT HUB
    if (clean === '/skill-resources') {
      let resources = LocalStore.get('skillResources');
      if (params.skill) {
        resources = resources.filter(r => r.skillName.toLowerCase() === params.skill.toLowerCase());
      }
      if (params.category && params.category !== 'ALL') {
        resources = resources.filter(r => r.category.toLowerCase().includes(params.category.toLowerCase()));
      }
      return { resources, count: resources.length };
    }

    if (clean.startsWith('/skill-resources/')) {
      const id = parseInt(clean.substring('/skill-resources/'.length));
      const res = LocalStore.get('skillResources').find(r => r.id === id);
      if (!res) throw new Error('Skill resource module not found.');
      return { resource: res };
    }

    // 12. ONLINE CERTIFICATION & ASSESSMENTS
    if (clean === '/assessments') {
      const list = LocalStore.get('assessments').map(a => ({
        id: a.id,
        skillName: a.skillName,
        title: a.title,
        durationMinutes: a.durationMinutes,
        passingPercentage: a.passingPercentage,
        totalQuestions: a.questions ? a.questions.length : a.totalQuestions,
        nsqfLevel: a.nsqfLevel
      }));
      return { assessments: list };
    }

    if (clean.startsWith('/assessments/') && clean.endsWith('/submit') && method === 'POST') {
      const id = parseInt(clean.substring('/assessments/'.length, clean.indexOf('/submit')));
      const assessment = LocalStore.get('assessments').find(a => a.id === id);
      ...
      questions.forEach((q, idx) => {
        if (answers[q.id] !== undefined && parseInt(answers[q.id]) === q.correct) {
          score++;
        }
      });
      ...
      if (passed && user && user.role === 'STUDENT') {
        const profile = this.getPopulatedStudentProfile(user.id);
        const allSkills = LocalStore.get('skills');
        const allCerts = LocalStore.get('certificates');

        // Mark skill as verified in student's profile
        let sk = allSkills.find(s => s.studentProfileId === profile.id && s.name.toLowerCase() === assessment.skillName.toLowerCase());
        if (sk) {
          sk.verified = true;
          sk.level = 'EXPERT';
        } else {
        ...
        // Award verified government credential
        const certId = allCerts.length + 10;
        certificate = {
          id: certId,
          studentProfileId: profile.id,
          skillId: sk.id,
          skillName: assessment.skillName,
          name: `National Skill Attestation: ${assessment.skillName}`,
          issuingOrganization: 'Saksham Setu National Testing Authority (TEE Certified)',
          certificateUrl: `uploads/cert_saksham_${certId}.pdf`,
          issueDate: new Date().toISOString().split('T')[0],
          credentialId: `SS-TEE-${Date.now().toString(36).toUpperCase()}-${certId}`
        };
        allCerts.unshift(certificate);
        LocalStore.set('certificates', allCerts);
        ...
        notifs.unshift({
          id: notifs.length + 10,
          userId: user.id,
          title: `Certification Passed: ${assessment.skillName}`,
          message: `Congratulations! You scored ${percentage}% on the proctored assessment. Your certificate (${certificate.credentialId}) is now active.`,
          category: "SYSTEM",
          priority: "HIGH",
          actionUrl: "student-profile.html",
          read: false,
          createdAt: new Date().toLocaleDateString()
        });
        LocalStore.set('notifications', notifs);
    ...
    if (clean.startsWith('/assessments/')) {
      const id = parseInt(clean.substring('/assessments/'.length));
      const assessment = LocalStore.get('assessments').find(a => a.id === id);
      if (!assessment) throw new Error('Assessment not found.');
  ...
  sendEmailNotification(toEmail, subject, htmlBody, meetingLink = '') {
    const emailRecord = {
      id: Date.now(),
      to: toEmail,
      subject: subject,
    ...
    const outbox = LocalStore.get('emailOutbox') || [];
    outbox.unshift(emailRecord);
    LocalStore.set('emailOutbox', outbox);

    console.log(`%c[EMAIL DISPATCHED TO: ${toEmail}]`, 'color:#22c55e; font-weight:bold; font-size:12px;', {
      subject,
      meetingLink,
      sentAt: emailRecord.sentAt
    });

    // Display non-intrusive floating toast notifying the user
    if (typeof document !== 'undefined') {
      let toast = document.getElementById('saksham-email-toast');
      if (!toast) {
        toast = document.createElement('div');
        toast.id = 'saksham-email-toast';
        toast.style.cssText = 'position:fixed; bottom:24px; right:24px; z-index:99999; background:#0f172a; color:#f8fafc; border:2px solid #22c55e; border-radius:8px; padding:14px 18px; box-shadow:0 10px 25px rgba(0,0,0,0.3); max-width:380px; font-family:sans-serif; animation:slideIn 0.3s ease;';
        document.body.appendChild(toast);
      }
      toast.innerHTML = `
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
          <span style="font-weight:800; color:#22c55e; font-size:13px;">📧 Official Email Dispatched!</span>
          <button onclick="this.parentElement.parentElement.remove()" style="background:none; border:none; color:#94a3b8; cursor:pointer; font-size:16px;">✕</button>
        </div>
        <div style="font-size:12px; color:#cbd5e1; margin-bottom:6px;">
          To: <strong>${toEmail}</strong><br>
          Subject: <strong>${subject}</strong>
        </div>
        ${meetingLink ? `<div style="margin-top:6px;"><a href="${meetingLink}" target="_blank" style="background:#2563eb; color:#fff; padding:4px 10px; border-radius:4px; text-decoration:none; font-size:11px; font-weight:700;">Join Meeting Link 📹</a></div>` : ''}
      `;
      setTimeout(() => {
