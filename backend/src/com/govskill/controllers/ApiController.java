            ...
            if ("GET".equals(method)) {
                ...
                if (currentUser != null && "STUDENT".equalsIgnoreCase(currentUser.getRole())) {
                    ...
                    if (sp != null) {
                        ...
                        MatchingService.SkillGapResult gap = MatchingService.getSkillGap(sp, opp);
                ...
                resp.put("matchedSkills", matchedSkills);
                resp.put("missingSkills", missingSkills);
                resp.put("skillGap", missingSkills);
